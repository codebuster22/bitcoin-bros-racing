...
var SPRITES = {
  ...
  PLAYER_UPHILL_RIGHT:    { x: 1067, y:  480, w:   26, h:   41 },
  PLAYER_UPHILL_STRAIGHT: { x: 1031, y:  480, w:   26, h:   41 },
  PLAYER_UPHILL_LEFT:     { x:  995, y:  480, w:   26, h:   41 },
  PLAYER_LEFT:            { x:  995, y:  480, w:   26, h:   41 },
  PLAYER_STRAIGHT:        { x: 1031, y:  480, w:   26, h:   41 },
  PLAYER_RIGHT:           { x: 1067, y:  480, w:   26, h:   41 }
};

SPRITES.SCALE = 0.15 * (1/SPRITES.PLAYER_STRAIGHT.w) // the reference sprite width should be 1/3rd the (half-)roadWidth
